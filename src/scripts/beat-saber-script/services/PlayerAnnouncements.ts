import { SSPlayer, PlayerScore, Leaderboard } from "../models/index"
import { TextChannel } from "discord.js"
import { roundNumber } from "@utils/math"
import { UserManager } from "@scripts/core-script/services/UserManager"
import { PlayerPerformanceInfo, countryNames } from "../types"
...
export class PlayerAnnouncements {
     ...
     * @param leaderboardId 
     */
    public async playerHasFirstScoredRankedMap(player: SSPlayer, score: PlayerScore) {
     ...
     */
    public async playerMadeTopServerScore(player: SSPlayer, newScore: PlayerScore, snipedScore: PlayerScore) {
     ...
     * @param snipedScore PlayerScore object with SSPlayer eager loaded.
     */
    public async playerMadeTopCountryScore(player: SSPlayer, newScore: PlayerScore, snipedScore: PlayerScore) {
     ...
     * @returns 
     */
    private getSnipedScoreDetailsMessage(leaderboard: Leaderboard, newScore: PlayerScore, snipedScore: PlayerScore): string {
        let message = "";
     ...
     * @param snipedScore PlayerScore object with SSPlayer eager loaded.
     */
     public async playerImprovedTopScore(player: SSPlayer, newScore: PlayerScore, oldScore: PlayerScore) {
     ...
     * @param oldScore 
     */
    public async playerSignificantlyImprovedOwnScore(player: SSPlayer, newScore: PlayerScore, oldScore: PlayerScore) {
     ...
     * @param player 
     */
    private discordMention(player: SSPlayer) {
