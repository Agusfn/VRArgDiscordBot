import { SSPlayer, Leaderboard, PlayerScore } from "../models/index"
...
import { LeaderboardInfo, PlayerScoreCollection, PlayerScore as APIPlayerScore } from "@services/ScoreSaber/types"

type LeaderboardI = any
type PlayerScoreI = any
...
export class PlayerScoreSaver {
     ...
     * @returns 
     */
    private playerScoreFromAPIScore(apiScore: APIPlayerScore, ssPlayerId: string): PlayerScoreI {
