...
export const SPICY_ANNOUNCEMENTS_CHANNEL = 121654564

export const INTERESTING_SCORE_THRESHOLD = 123

/** Channel id for when there is any new score announcement. */
export const SCORE_ANNOUNCEMENTS_CHANNEL_ID = "856383011443572766"
